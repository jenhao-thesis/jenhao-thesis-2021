...
\begin{figure}[htb]
    \centering
    \frame{\includegraphics[height=!,width=0.85\linewidth,keepaspectratio=true]{figures/screenshot_controlpanelmode1.png}}
...
\begin{figure}[htb]
    \centering
    \frame{\includegraphics[height=!,width=0.85\linewidth,keepaspectratio=true]{figures/screenshot_authconfirm1.png}}
...
\begin{figure}[htb]
    \centering
    \frame{\includegraphics[height=!,width=0.85\linewidth,keepaspectratio=true]{figures/screenshot_controlpanelmode2.png}}
...
\begin{figure}[htb]
    \centering
    \frame{\includegraphics[height=!,width=0.85\linewidth,keepaspectratio=true]{figures/screenshot_requestJWT.png}}
