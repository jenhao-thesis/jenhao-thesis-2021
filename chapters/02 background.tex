...
Fu \emph{et al.}~\cite{fu2020soteria} proposed a user right management system to protect user-data privacy with two-layer blockchain. It is not only transparent and secure, but also comply with GDPR.